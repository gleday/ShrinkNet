...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(HiddenVarRidgeiGetKappa(ii, SVDs, tX, aRand, bRand, bRandStarInit, dSigmaStarInit));
    return __result;
END_RCPP
}
// HiddenVarAlgo
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(HiddenVarAlgo(SVDs, tX, aRand, bRand, maxiter, globalShrink, tol, verbose));
    return __result;
END_RCPP
}
// getSVD
