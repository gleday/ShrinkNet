...
ShrinkNet enables the reconstruction of an undirected network from high-throughput molecular data. This characterizes the *conditional independence* structure between the molecular variables.
